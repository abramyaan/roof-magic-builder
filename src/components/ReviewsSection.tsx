...
const reviews = [
  ...
  { name: "Дмитрий В.", text: "Заказывал монтаж металлочерепицы. Ребята профессионалы, работают чётко. Цена адекватная, гарантию дали.", rating: 5 },
  ...
  { name: "Наталья Р.", text: "Заказывали водосточную систему. Установили качественно, выглядит аккуратно. Цена порадовала.", rating: 5 },
];
